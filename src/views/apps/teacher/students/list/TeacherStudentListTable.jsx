        ...
        <div className='flex flex-wrap justify-between gap-4 p-6'>
          ...
          <div className='flex flex-wrap items-center max-sm:flex-col gap-4 max-sm:is-full is-auto'>
            <Button
              ...
              href={getLocalizedUrl('/apps/teacher/students/new', locale)}
                            ...
                            >
                              ...
                              >
                                <div className='flex items-center'>
                                  <Link
                                    href={getLocalizedUrl(`/apps/teacher/students/${n.id}`, locale)}
                                  >
                                    <IconButton>
                                  ...
                                  <OptionMenu
                                    ...
                                    options={[
                                      ...
                                      },
                                      {
                                        text: 'Delete',
                                        icon: 'tabler-trash',
                                        menuItemProps: { onClick: () => deleteTeacherStudent(n.id) }
                                      },
                                    ]}
                                  />
                                </div>
