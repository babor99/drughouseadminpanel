...
const RegisterCompetitionDialog = ({ loading, open, setOpen, fields, setFields, currentCompetitionId, createCompetitionEnrollment }) => {
    const handleClose = () => {
        setOpen(false)
    }
            ...
            <form onSubmit={e => e.preventDefault()}>
                ...
                <DialogActions className='justify-center pbs-0'>
                    <Button
                        ...
                        disabled={loading}
                        onClick={() => createCompetitionEnrollment(currentCompetitionId, fields)}
                    >
                        Join
                    </Button>
                </DialogActions>
