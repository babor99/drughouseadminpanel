...
import { CREATE_RPM_STUDENT, UPDATE_RPM_STUDENT } from '@/constants/constants'
...
const FormHeader = () => {
  ...
  function handleUpdateRPMStudent() {
    setLoading(true)
    ...
    try {
      fetch(`${UPDATE_RPM_STUDENT}${studentId}`, {
        method: 'PUT',
        credentials: 'include',
        headers: authHeaders.headers,
        body: formData,
  ...
  return (
    <div className='flex flex-wrap sm:items-center justify-between max-sm:flex-col gap-6'>
      ...
      <div className='flex flex-wrap max-sm:flex-col gap-4'>
        <Link href={getLocalizedUrl(`/en/apps/rpm/students`, locale)}>
        ...
        </Link>
        {
          studentId === 'new' ?
            ...
            <Button
              variant='contained'
              disabled={!isValid || isEmpty(dirtyFields) || loading}
              onClick={handleUpdateRPMStudent}
            >
              Update
            </Button>
        }
