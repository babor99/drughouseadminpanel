...
import RPMSchoolTableHead from './RPMSchoolTableHead'
        ...
        <div className='flex flex-wrap justify-between gap-4 p-6'>
          <CustomTextField
            ...
            onChange={e => {
              ...
              if (e.target.value.length === 0) {
                getAllRPMSchool({ ...params, keyword: '' })
              }
            }}
            onKeyDown={(e) => {
              if (e.key === 'Enter') {
                getAllRPMSchool({ ...params, keyword: e.target.value })
              }
            }}
          />
          <div className='flex flex-wrap items-center max-sm:flex-col gap-4 max-sm:is-full is-auto'>
            <Button
              ...
              href={getLocalizedUrl('/apps/rpm/schools/new', locale)}
                          ...
                          return (
                            ...
                            >
                              ...
                              <TableCell
                                ...
                                scope="row"
                              >
                                <Link href={getLocalizedUrl(`/apps/rpm/schools/${n.id}`, locale)}>{n.name}</Link>
                              </TableCell>
                              <TableCell
                                className="px-2 md:px-4 whitespace-nowrap"
                                component="th"
                              ...
                              >
                                <div className='flex items-center'>
                                  <Link
                                    href={getLocalizedUrl(`/apps/rpm/schools/${n.id}`, locale)}
                                  >
                                    <IconButton>
                                    ...
                                    options={[
                                      {
                                        text: 'Delete',
                                        icon: 'tabler-trash',
                                        menuItemProps: { onClick: () => deleteRPMSchool(n.id) }
                                      },
                                    ]}
                                  />
                                </div>
