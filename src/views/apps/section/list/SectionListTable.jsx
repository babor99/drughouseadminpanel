        ...
        <div className='flex flex-wrap justify-between gap-4 p-6'>
          <CustomTextField
            ...
            onChange={e => {
              ...
              if (e.target.value.length === 0) {
                getAllSection({ ...params, keyword: '' })
              }
            }}
            onKeyDown={(e) => {
              if (e.key === 'Enter') {
                getAllSection({ ...params, keyword: e.target.value })
              }
            }}
          />
          <div className='flex flex-wrap items-center max-sm:flex-col gap-4 max-sm:is-full is-auto'>
            <Button
              ...
              href={getLocalizedUrl('/apps/section/new', locale)}
                          ...
                          return (
                            ...
                            >
                              ...
                              <TableCell
                                ...
                                scope="row"
                              >
                                <Link href={getLocalizedUrl(`/apps/section/${n.id}`, locale)}>{n.name}</Link>
                              </TableCell>
                              ...
                              >
                                <div className='flex items-center'>
                                  <Link
                                    href={getLocalizedUrl(`/apps/section/${n.id}`, locale)}
                                  >
                                    <IconButton>
                                    ...
                                    options={[
                                      {
                                        text: 'Delete',
                                        icon: 'tabler-trash',
                                        menuItemProps: { onClick: () => deleteSection(n.id) }
                                      },
                                    ]}
                                  />
                                </div>
