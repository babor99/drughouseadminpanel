        ...
        <div className='flex flex-wrap justify-between gap-4 p-6'>
          <CustomTextField
            ...
            onChange={e => {
              if (e.target.value.length === 0) {
                getAllProductCategory({ ...params, keyword: '' })
                setParams({ ...params, keyword: '' })
              }
            }}
            onKeyDown={(e) => {
              if (e.key === 'Enter' && e.target.value) {
                getAllProductCategory({ ...params, keyword: e.target.value })
          ...
          <div className='flex flex-wrap items-center max-sm:flex-col gap-4 max-sm:is-full is-auto'>
            <Button
              ...
              href={getLocalizedUrl('/apps/store/product-categories/new', locale)}
                ...
                <div id="downloadPage">
                  ...
                  >
                    <ProductCategoryTableHead
                      ...
                      rowCount={productcategoryData.length}
                          ...
                          return (
                            ...
                            >
                              ...
                              <TableCell
                                ...
                                scope="row"
                              >
                                <Link href={getLocalizedUrl(`/apps/store/product-categories/${n.id}`, locale)}>{n.name}</Link>
                              </TableCell>
                              <TableCell
                                className="px-2 md:px-4 whitespace-nowrap"
                                component="th"
                                scope="row"
                              >
                                <img src={`${BASE_URL}/${n.icon}`} width={50} height={50} />
                              </TableCell>
                              <TableCell
                                className="px-2 md:px-4 whitespace-nowrap"
                                component="th"
                                scope="row"
                              >
                                <img src={`${BASE_URL}/${n.image}`} width={50} height={50} />
                              </TableCell>
                              <TableCell
                                className="px-2 md:px-4 whitespace-nowrap"
                                component="th"
                              ...
                              >
                                <div className='flex items-center'>
                                  <Link
                                    href={getLocalizedUrl(`/apps/store/product-categories/${n.id}`, locale)}
                                  >
                                    <IconButton>
                                    ...
                                    options={[
                                      {
                                        text: 'Delete',
                                        icon: 'tabler-trash',
                                        menuItemProps: { onClick: () => deleteProductCategory(n.id) }
                                      },
                                    ]}
                                  />
                                </div>
