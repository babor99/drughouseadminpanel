          ...
          <CustomTextField
            ...
            onChange={e => {
              ...
              if (e.target.value.length === 0) {
                getAllSchool({ ...params, keyword: '' })
              }
            }}
            onKeyDown={(e) => {
              if (e.key === 'Enter') {
                getAllSchool({ ...params, keyword: e.target.value })
              }
            }}
          />
                          ...
                          return (
                            ...
                            >
                              ...
                              <TableCell
                                ...
                                scope="row"
                              >
                                <Link href={getLocalizedUrl(`/apps/store/schools/${n.id}`, locale)}>{n.name}</Link>
                              </TableCell>
                              <TableCell
                                className="px-2 md:px-4 whitespace-nowrap"
                                component="th"
                              ...
                              >
                                <div className='flex items-center'>
                                  <Link
                                    href={getLocalizedUrl(`/apps/store/schools/${n.id}`, locale)}
                                  >
                                    <IconButton>
                                    ...
                                    options={[
                                      {
                                        text: 'Delete',
                                        icon: 'tabler-trash',
                                        menuItemProps: { onClick: () => deleteSchool(n.id) }
                                      },
                                    ]}
                                  />
                                </div>
