...
const ProductListTable = (props) => {
  ...
  const redirectToChangePassword = (employeeId) => {

    router.replace(getLocalizedUrl(`/apps/store/employees/change-password/${employeeId}`, locale))
  }
        ...
        <div className='flex flex-wrap justify-between gap-4 p-6'>
          ...
          <div className='flex flex-wrap items-center max-sm:flex-col gap-4 max-sm:is-full is-auto'>
            <Button
              ...
              href={getLocalizedUrl('/apps/store/employees/new', locale)}
                          ...
                          return (
                            ...
                            >
                              ...
                              <TableCell
                                ...
                                scope="row"
                              >
                                <Link href={getLocalizedUrl(`/apps/store/employees/${n.id}`, locale)}>{n.name}</Link>
                              </TableCell>
                              <TableCell
                                className="px-2 md:px-4 whitespace-nowrap"
                                component="th"
                              ...
                              >
                                <div className='flex items-center'>
                                  <Link
                                    href={getLocalizedUrl(`/apps/store/employees/${n.id}`, locale)}
                                  >
                                    <IconButton>
                                  ...
                                  <OptionMenu
                                    ...
                                    options={[
                                      ...
                                      },
                                      {
                                        text: 'Delete',
                                        icon: 'tabler-trash',
                                        menuItemProps: { onClick: () => deleteEmployee(n.id) }
                                      },
                                    ]}
                                  />
                                </div>
