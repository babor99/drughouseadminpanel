    ...
    <Card>
      <CardContent className='flex flex-col gap-6'>
        ...
        <div className='flex items-center gap-3'>
          ...
          <div className='flex flex-col'>
            <Typography color='text.primary' className='font-medium'>
              {orderData?.user ? orderData?.user?.name : orderData?.customer_name}
            </Typography>
        ...
        <div className='flex flex-col gap-1'>
          ...
          <Typography>Email: {orderData?.user ? orderData?.user?.email : orderData?.customer_email}</Typography>
          <Typography>Mobile: {orderData?.user ? orderData?.user?.phone_number : orderData?.customer_phone}</Typography>
        </div>
      </CardContent>
    </Card>
  )
