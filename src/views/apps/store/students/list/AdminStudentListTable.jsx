...
const AdminStudentListTable = (props) => {
  ...
  const redirectToChangePassword = (studentId) => {
    ...
    router.replace(getLocalizedUrl(`/apps/store/students/change-password/${studentId}`, locale))
  }
        ...
        <div className='flex flex-wrap justify-between gap-4 p-6'>
          ...
          <div className='flex flex-wrap items-center max-sm:flex-col gap-4 max-sm:is-full is-auto'>
            <Button
              ...
              href={getLocalizedUrl('/apps/store/students/new', locale)}
                          ...
                          return (
                            ...
                            >
                              ...
                              <TableCell
                                ...
                                scope="row"
                              >
                                <Link href={getLocalizedUrl(`/apps/store/students/${n.id}`, locale)}>{n.name} {n.last_name}</Link>
                              </TableCell>
                              <TableCell
                                className="px-2 md:px-4 whitespace-nowrap"
                                component="th"
                              ...
                              >
                                <div className='flex items-center'>
                                  <Link
                                    href={getLocalizedUrl(`/apps/store/students/${n.id}`, locale)}
                                  >
                                    <IconButton>
