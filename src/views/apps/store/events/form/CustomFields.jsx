...
const CustomFields = ({ fields, setFields }) => {
  ...
  const setFieldIsRequired = (index, value) => {
    const updatedFields = fields.map((field, idx) =>
      idx === index ? { ...field, is_required: value } : field
    );
                ...
                <div className='flex items-center justify-between'>
                  <div className='flex items-center justify-start'>
                    ...
                    <div className='flex items-center justify-start ms-2'>
                      <Typography variant='h6' className='text-primary'>Required?</Typography>
                      <Checkbox
                        checked={field?.is_required}
                        onChange={e => setFieldIsRequired(fIndex, e.target.checked)}
                      />
                    </div>
                  </div>
