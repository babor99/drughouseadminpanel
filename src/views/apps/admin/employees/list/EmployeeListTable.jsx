...
const ProductListTable = (props) => {
  ...
  const redirectToChangePassword = (employeeId) => {
    ...
    router.replace(getLocalizedUrl(`/apps/admin/employees/change-password/${employeeId}`, locale))
  }
        ...
        <div className='flex flex-wrap justify-between gap-4 p-6'>
          ...
          <div className='flex flex-wrap items-center max-sm:flex-col gap-4 max-sm:is-full is-auto'>
            <Button
              ...
              href={getLocalizedUrl('/apps/admin/employees/new', locale)}
                            ...
                            >
                              ...
                              >
                                <div className='flex items-center'>
                                  <Link
                                    href={getLocalizedUrl(`/apps/admin/employees/${n.id}`, locale)}
                                  >
                                    <IconButton>
