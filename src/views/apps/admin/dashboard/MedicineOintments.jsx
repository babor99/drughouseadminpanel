  ...
  return (
    <Card>
      <CardContent className='flex flex-col gap-y-3 items-start'>
        ...
        <Typography variant='h6'>Ointments ({data?.product_counts?.total_ointment_types_count})</Typography>
          <Typography variant='h5' color='text.primary'>{data?.product_counts?.total_ointments_count} qty</Typography>
        </div>
      </CardContent>
    </Card>
  )
