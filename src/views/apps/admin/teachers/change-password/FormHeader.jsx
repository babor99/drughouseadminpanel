...
import { SET_TEACHER_PASSWORD } from '@/constants/constants';
...
const FormHeader = () => {
  ...
  function setTeacherPassword() {
    ...
    try {
      fetch(`${SET_TEACHER_PASSWORD}${teacherId}`, authHeaders)
        .then(res => {
        ...
        .then(data => {
          ...
          router.replace(getLocalizedUrl('/apps/admin/teachers', locale))
        })
        .catch(error => {
          setLoading(false)
