...
const ProductListTable = (props) => {
  ...
  const redirectToChangePassword = (teacherId) => {
    ...
    router.replace(getLocalizedUrl(`/apps/admin/teachers/change-password/${teacherId}`, locale))
  }
        ...
        <div className='flex flex-wrap justify-between gap-4 p-6'>
          ...
          <div className='flex flex-wrap items-center max-sm:flex-col gap-4 max-sm:is-full is-auto'>
            <Button
              ...
              href={getLocalizedUrl('/apps/admin/teachers/new', locale)}
                          ...
                          return (
                            ...
                            >
                              ...
                              <TableCell
                                ...
                                scope="row"
                              >
                                <Link href={getLocalizedUrl(`/apps/admin/teachers/${n.id}`, locale)}>{n.name} {n.last_name}</Link>
                              </TableCell>
                              <TableCell
                                className="px-2 md:px-4 whitespace-nowrap"
                                component="th"
                              ...
                              >
                                <div className='flex items-center'>
                                  <Link
                                    href={getLocalizedUrl(`/apps/admin/teachers/${n.id}`, locale)}
                                  >
                                    <IconButton>
