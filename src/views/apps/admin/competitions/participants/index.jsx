...
import {
    GET_ALL_COMPETITION_PARTICIPANT_BY_COMPETITION_ID,
    DOWNLOAD_COMPETITION_PARTICIPANT_BY_COMPETITION_ID
...
const ParticipantList = () => {
    ...
    function handleRequestSort(participant, property) {
        const id = property;
        let direction = 'desc';
    ...
    function getAllParticipant() {
        ...
        try {
            fetch(`${GET_ALL_COMPETITION_PARTICIPANT_BY_COMPETITION_ID}${competitionId}?${objectToQueryString(params)}`, authHeaders)
                .then(res => {
                ...
                .then(data => {
                    ...
                    setCurrentCompetition(data?.competition)
                    setLoading(false)
                })
                .catch(error => {
    ...
    const downloadAllParticipant = async () => {
        ...
        try {
            const response = await fetch(`${DOWNLOAD_COMPETITION_PARTICIPANT_BY_COMPETITION_ID}${competitionId}`, {
